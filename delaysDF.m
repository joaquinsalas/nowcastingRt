...
classdef delaysDF
    ...
    methods
        ...
        function    theta = compoundRateOfChange3(obj, draw)
            c = crcCommon;
            theta = c.crc(obj.masterFile, obj.prefix, draw);
        end
        
        
        function nowcastingCompound2(obj, theta)
            c = crcCommon;
            c.nowcasting(obj.masterFile, theta);
            
        end
        
        function nowcastingSamples2(obj, theta)
            c = crcCommon;
            c.sampling(obj.masterFile, obj.prefix, theta);
        ...
        function runme(obj)
            ...
            obj.nowcastingCompound2(theta);
            obj.nowcastingSamples2(theta);
